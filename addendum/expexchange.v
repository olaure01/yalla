From Stdlib Require Import Permutation PeanoNat Lia.
...
Definition exwn := forall P l1 lw lw' l2,
  ll P (l1 ++ map wn lw ++ l2) -> Permutation_Type lw lw' -> ll P (l1 ++ map wn lw' ++ l2).
Check ex_wn_r : exwn.
