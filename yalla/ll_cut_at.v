...
- symmetry in Heq. trichot_elt_app_inf_exec Heq; subst.
  ...
  + symmetry in Heq1. decomp_map_inf Heq1.
...
enough (forall s A l0 l1 l2 (pi1: ll P (A :: l0)) (pi2 : ll P (l1 ++ dual A :: l2)),
  ...
  as Hat.
{ intros pi1 pi2. eapply ex_r; [ | apply PCPermutation_Type_app_comm ].
  rewrite app_assoc, <- 2 app_assoc. eapply ex_r; [ | apply PCPermutation_Type_app_comm ].
  rewrite <- app_assoc. apply (ex_r _ ((var X :: l2) ++ l1)) in pi1; [ | apply PCPermutation_Type_app_comm ].
...
- trichot_elt_app_inf_exec Heql; subst.
  + rewrite 2 app_assoc. eapply ex_wn_r; [ | apply HP ].
    ...
    refine (IHsize0 (psize pi1 + psize Hl) _ _ _ _ _ pi1 Hl _ Hat); lia.
  + symmetry in Heql1. decomp_map_inf Heql1.
    destruct Hat as [-> | ->]; discriminate Heql1.
...
- destruct l1; inversion Heql; subst.
  + destruct Hat as [-> | ->]; discriminate H0.
  + decomp_map_inf H1.
    destruct Hat as [-> | ->]; discriminate H1.
- destruct l1; inversion Heql; subst.
  + destruct Hat as [-> | ->]; discriminate H0.
  + cbn. apply de_r.
    revert Hl IHsize0. rewrite app_comm_cons. intros Hl IHsize0.
