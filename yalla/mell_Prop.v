...
Proof.
intros pi. induction pi; try ((try inversion IHpi); do 2 constructor; assumption); rewrite ? map_app.
- apply Permutation_Permutation_transp in H.
  induction H.
  + inversion IHpi. constructor. assumption.
  ...
  + apply IHPermutation_transp2.
    ...
    * apply IHPermutation_transp1; assumption.
...
revert l Heql0. induction pi; intros l' Heql0; subst;
  try (destruct l'; inversion Heql0; destruct f; inversion H0; assumption).
- symmetry in Heql0. decomp_map Heql0. subst.
  destruct l1; inversion Heql4. destruct x; inversion Heql2. destruct x0; inversion Heql0. subst.
  apply ax_r.
- cbn in p.
...
apply inhmellfrag2mell. constructor.
rewrite map_app.
eapply ll_cut.cut_r_axfree; [ intros [] | rewrite mell2ll_dual | ]; eassumption.
Qed.
