...
- case_eq (ipperm P) ; intros Hperm ; rewrite Hperm in p ; cbn in p ; subst.
  + destruct (Permutation_Type_app_flat_map_cst _ (map ioc lw) _ _ p) as [[L' l''] (Hnil' & HeqL' & HPL')] ;
...
- elt_vs_app_flat_map_cst_inv Heq.
  ...
  + app_vs_app_flat_map_cst_inv Heq2.
    * list_simpl ; rewrite ? flat_map_app ; list_simpl.
      ...
      apply lpam_ilr...
      list_simpl.
      replace (flat_map (app (map ioc lw)) L0 ++ map ioc lw ++ l ++ B :: l1 ++ flat_map (app (map ioc lw)) L1)
...
- (* one_ilr *)
  ...
  + remember (one_ilr _ _ _ _ Hl) as Hone ; clear HeqHone.
    ...
    * apply (ex_ir _ (l3 ++ l ++ l4)).
      -- cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hone _ _)...
      -- apply PEPermutation_Type_app_head ; apply PEPermutation_Type_app_tail...
    * list_simpl ; rewrite app_assoc ; eapply ex_oc_ir...
    ...
    * list_simpl ; rewrite app_assoc ; apply lpam_ilr...
      ...
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hone _ _)...
    * list_simpl ; rewrite app_assoc ; apply lmap_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hone _ _)...
    * list_simpl ; rewrite app_assoc ; apply with_ilr1.
...
- (* tens_ilr *)
  ...
  + remember (tens_ilr _ _ _ _ _ _ Hl) as Htens ; clear HeqHtens.
    ...
    * apply (ex_ir _ (l3 ++ l ++ l4)).
      -- cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Htens _ _)...
      -- apply PEPermutation_Type_app_head ; apply PEPermutation_Type_app_tail...
    * list_simpl ; rewrite app_assoc ; eapply ex_oc_ir...
      list_simpl ; rewrite (app_assoc l) ; rewrite (app_assoc _ l2) ; rewrite <- (app_assoc l).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Htens _ _)...
    ...
    * rewrite <- app_assoc ; rewrite app_assoc.
      cbn in Hc ; subst ; refine (IHcut _ _ _ _ _ _ Hr2 _)...
    ...
    * list_simpl ; rewrite app_assoc ; apply lpam_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Htens _ _)...
    * list_simpl ; rewrite app_assoc ; apply lmap_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Htens _ _)...
    * list_simpl ; rewrite app_assoc ; apply with_ilr1.
...
- (* lpam_ilr *)
  ...
  + change (S (ipsize Hl + ipsize Hr)) with (ipsize (lpam_ilr _ _ _ _ _ _ _ Hl Hr)) in IHsize.
    ...
    * apply (ex_ir _ (l4 ++ l ++ l3 ++ l5)).
      -- cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hlpam _ _)...
      -- apply PEPermutation_Type_app_head ; apply PEPermutation_Type_app_tail...
    * list_simpl ; rewrite app_assoc ; eapply ex_oc_ir...
      list_simpl ; rewrite (app_assoc l) ; rewrite (app_assoc _ l2) ; rewrite <- (app_assoc l).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hlpam _ _)...
    ...
    * list_simpl ; rewrite app_assoc ; apply tens_ilr.
      ...
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hlpam _ _)...
    * rewrite app_assoc.
      cbn in Hc ; subst ; refine (IHcut _ _ _ _ _ _ Hl _)...
      list_simpl ; change (A0 :: l5) with ((A0 :: nil) ++ l5) ; rewrite (app_assoc l).
      refine (IHcut _ _ _ _ _ _ Hl2 Hr)...
    * list_simpl ; rewrite app_assoc ; apply lpam_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hlpam _ _)...
    * list_simpl ; rewrite app_assoc ; apply lmap_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hlpam _ _)...
    * list_simpl ; rewrite app_assoc ; apply with_ilr1.
...
- (* gen_ilr *)
  ...
  + remember (gen_ilr _ _ _ Hl) as Hgen ; clear HeqHgen.
    ...
    * apply (ex_ir _ (nil ++ l' ++ l2)).
      -- revert Hgen IHsize ; rewrite <- (app_nil_l _) ; intros Hgen IHsize.
         refine (IHsize _ _ _ _ _ Hl2 Hgen _ _) ; cbn...
      -- apply PEPermutation_Type_app_head ; apply PEPermutation_Type_app_tail...
    ...
    * rewrite <- ? app_assoc ; rewrite <- app_comm_cons ; rewrite <- app_assoc ; rewrite app_assoc.
      ...
      revert Hgen IHsize ; rewrite <- (app_nil_l _) ; intros Hgen IHsize.
      refine (IHsize _ _ _ _ _ Hr2 Hgen  _ _) ; cbn...
    * subst ; list_simpl ; rewrite <- (app_nil_r _) ; rewrite <- app_assoc.
      refine (IHcut _ _ _ _ _ _ Hl Hl2) ; cbn...
  ...
  + list_simpl ; apply gen_ilr.
    refine (IHsize _ _ _ _ _ pi1 Hl _ _) ; cbn...
- (* lmap_irr *)
  cbn in IHsize.
  apply lmap_irr.
...
- (* lmap_ilr *)
  ...
  + change (S (ipsize Hl + ipsize Hr)) with (ipsize (lmap_ilr _ _ _ _ _ _ _ Hl Hr)) in IHsize.
    ...
    * apply (ex_ir _ ((l4 ++ l3) ++ l ++ l5)).
      -- cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hlmap _ _)...
      -- apply PEPermutation_Type_app_head ; apply PEPermutation_Type_app_tail...
    ...
    * list_simpl ; rewrite 2 app_assoc ; apply lpam_ilr...
      ...
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hlmap _ _)...
    * list_simpl ; cbn in Hc ; subst ; refine (IHcut _ _ _ _ _ _ Hl _)...
...
- (* neg_ilr *)
  ...
  + remember (neg_ilr _ _ _ Hl) as Hneg ; clear HeqHneg.
    ...
    * apply (ex_ir _ (l ++ l' ++ nil)).
      -- cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hneg _ _)...
      -- apply PEPermutation_Type_app_head ; apply PEPermutation_Type_app_tail...
    * rewrite <- ? app_assoc ; rewrite app_assoc ; eapply ex_oc_ir...
    ...
    * rewrite <- ? app_assoc ; rewrite <- app_comm_cons ; rewrite <- app_assoc ; rewrite app_assoc.
      apply lpam_ilr...
      rewrite <- app_assoc ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hneg _ _)...
    * rewrite <- ? app_assoc ; rewrite app_assoc ; apply lmap_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hneg _ _)...
    * clear IHsize ; rewrite <- (app_nil_l (A :: l0)) in Hl2.
      list_simpl ; cbn in Hc ; subst ; refine (IHcut _ _ _ _ _ _ Hl Hl2)...
    * rewrite <- ? app_assoc ; rewrite app_assoc ; apply with_ilr1.
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hneg _ _)...
    * rewrite <- ? app_assoc ; rewrite app_assoc ; apply with_ilr2.
...
- (* with_ilr1 *)
  ...
  + remember (with_ilr1 _ _ _ _ _ _ Hl) as Hwith ; clear HeqHwith.
    ...
    * apply (ex_ir _ (l3 ++ l ++ l4)).
      -- cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hwith _ _)...
      -- apply PEPermutation_Type_app_head ; apply PEPermutation_Type_app_tail...
    * list_simpl ; rewrite app_assoc ; eapply ex_oc_ir...
      list_simpl ; rewrite (app_assoc l) ; rewrite (app_assoc _ l2) ; rewrite <- (app_assoc l).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hwith _ _)...
    ...
    * list_simpl ; rewrite app_assoc ; apply lpam_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hwith _ _)...
    * list_simpl ; rewrite app_assoc ; apply lmap_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hwith _ _)...
    * cbn in Hc ; subst ; refine (IHcut _ _ _ _ _ _ Hl2 Hl)...
    * list_simpl ; rewrite app_assoc ; apply with_ilr1.
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hwith _ _)...
    * list_simpl ; rewrite app_assoc ; apply with_ilr2.
...
- (* with_ilr2 *)
  ...
  + remember (with_ilr2 _ _ _ _ _ _ Hl) as Hwith ; clear HeqHwith.
    ...
    * list_simpl ; rewrite app_assoc ; apply lmap_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hwith _ _)...
    * cbn in Hc ; subst ; refine (IHcut _ _ _ _ _ _ Hr2 Hl)...
    * list_simpl ; rewrite app_assoc ; apply with_ilr1.
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hwith _ _)...
    * list_simpl ; rewrite app_assoc ; apply with_ilr2.
...
- (* zero_ilr *)
  ...
  + remember (zero_ilr _ l3 l4 C) as Hzero ; clear HeqHzero.
    ...
    * apply (ex_ir _ (l3 ++ l ++ l4)).
      -- cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hzero _ _)...
      -- apply PEPermutation_Type_app_head ; apply PEPermutation_Type_app_tail...
    * list_simpl ; rewrite app_assoc ; eapply ex_oc_ir...
      list_simpl ; rewrite (app_assoc l) ; rewrite (app_assoc _ l2) ; rewrite <- (app_assoc l).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hzero _ _)...
    ...
    * list_simpl ; rewrite app_assoc ; apply lpam_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hzero _ _)...
    * list_simpl ; rewrite app_assoc ; apply lmap_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hzero _ _)...
    * list_simpl ; rewrite app_assoc ; apply with_ilr1.
...
- (* plus_ilr *)
  ...
  + list_simpl.
    ...
    * revert Hl IHsize ; cbn ; rewrite app_comm_cons ; rewrite app_assoc ; intros Hl IHsize.
      rewrite app_comm_cons ; rewrite app_assoc.
      refine (IHsize _ _ _ _ _ pi1 Hl _ _)...
    * revert Hr IHsize ; cbn ; rewrite app_comm_cons ; rewrite app_assoc ; intros Hr IHsize.
      rewrite app_comm_cons ; rewrite app_assoc.
      refine (IHsize _ _ _ _ _ pi1 Hr _ _)...
  + remember (plus_ilr _ _ _ _ _ _ Hl Hr) as Hplus ; clear HeqHplus.
    ...
    * apply (ex_ir _ (l3 ++ l ++ l4)).
      -- cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hplus _ _)...
      -- apply PEPermutation_Type_app_head ; apply PEPermutation_Type_app_tail...
    * list_simpl ; rewrite app_assoc ; eapply ex_oc_ir...
      list_simpl ; rewrite (app_assoc l) ; rewrite (app_assoc _ l2) ; rewrite <- (app_assoc l).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hplus _ _)...
    ...
    * list_simpl ; rewrite app_assoc ; apply lpam_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hplus _ _)...
    * list_simpl ; rewrite app_assoc ; apply lmap_ilr...
      list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hplus _ _)...
    * list_simpl ; rewrite app_assoc ; apply with_ilr1.
    ...
    * list_simpl ; rewrite app_assoc ; apply zero_ilr.
    * cbn in Hc ; subst ; refine (IHcut _ _ _ _ _ _ Hl2 Hl)...
    * cbn in Hc ; subst ; refine (IHcut _ _ _ _ _ _ Hl2 Hr)...
    * list_simpl ; rewrite app_assoc ; apply plus_ilr.
      -- list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
         cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hplus _ _)...
      -- list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
...
- (* oc_irr *)
  ...
  + intros lw Hs' pi.
    ...
    revert Hl IHsize ; list_simpl ; intros Hl IHsize.
    refine (IHsize _ _ _ _ _ (oc_irr _ _ _ Hs') Hl _ _) ; cbn...
- (* de_ilr *)
  trichot_elt_elt_inf_exec Heql.
  + list_simpl.
    apply de_ilr.
  ...
  + eapply (cut_oc_comm_left _ (ipsize pi1))...
    * apply de_ilr...
    * intros lw Hs pi.
      cbn in Hc ; refine (IHsize _ _ _ _ _ Hs Hl _ _) ; cbn...
  + rewrite 2 app_assoc.
    apply de_ilr.
    revert Hl IHsize ; list_simpl ; intros Hl IHsize.
    refine (IHsize _ _ _ _ _ pi1 Hl _ _)...
...
- (* gax_ir *)
  ...
  cbn in IHsize.
  remember (gax_ir _ a) as Hgax ; apply (f_equal ipsize) in HeqHgax ; cbn in HeqHgax.
  destruct_ill pi1 f X l Hl2 Hr2 HP b ; try (exfalso ; inversion Hiq ; fail);
    ...
    try now (constructor; list_simpl; rewrite ? app_comm_cons; rewrite (app_assoc l1);
             ...
             [ rewrite HeqHgax; do 2 (rewrite Nat.add_comm; cbn); apply Nat.lt_succ_diag_r
             | assumption ]).
  + rewrite <- Heql ; apply (gax_ir _ a).
  + apply (ex_ir _ (l1 ++ l ++ l2)).
    * revert Hgax HeqHgax ; rewrite Heql ; intros Hgax HeqHgax.
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hgax _ _)...
    * list_simpl; apply PEPermutation_Type_app_head ; apply PEPermutation_Type_app_tail...
  + eapply ex_oc_ir...
    list_simpl ; rewrite (app_assoc l) ; rewrite (app_assoc _ l0) ; rewrite <- (app_assoc l).
    revert Hgax HeqHgax ; rewrite Heql ; intros Hgax HeqHgax.
    cbn in IHsize ; refine (IHsize _ _ _ _ _ Hl2 Hgax _ _)...
  + apply lpam_ilr...
    ...
    revert Hgax HeqHgax ; rewrite Heql ; list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l3) ;
      intros Hgax HeqHgax.
    cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hgax _ _)...
  + exfalso.
    apply (P_gax_noN_l a).
    rewrite Heql.
    apply in_inf_elt.
  ...
  + apply plus_ilr.
    ...
    * list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l1).
      revert Hgax HeqHgax ; rewrite Heql ; list_simpl ; rewrite app_comm_cons ; rewrite (app_assoc l0) ;
        intros Hgax HeqHgax.
      cbn in IHsize ; refine (IHsize _ _ _ _ _ Hr2 Hgax _ _)...
  + exfalso; rewrite f in P_cutfree ; inversion P_cutfree.
  + destruct (P_gax_cut b a _ _ Heql) as [x [Hx1 Hx2]].
    list_simpl; rewrite Hx1 ; rewrite Hx2.
    apply gax_ir.
