...
Lemma cut_oc_comm_left : ipcut P = false -> forall n A C l1 l2,
  (forall lw (pi0 : ill P (map ioc lw) A), ipsize pi0 < n ->
             ill P (l1 ++ ioc A :: l2) C -> ill P (l1 ++ map ioc lw ++ l2) C) ->
  forall l0 (pi1 : ill P l0 (ioc A)), ipsize pi1 <= n -> ill P (l1 ++ ioc A :: l2) C -> ill P (l1 ++ l0 ++ l2) C.
Proof with myeasy_perm_Type.
intros P_cutfree ; induction n ; intros A C l1 l2 IH l0 pi1 Hs pi2 ;
...
- apply (ex_ir _ (l1 ++ l ++ l2)).
  + simpl in Hs.
    refine (IHn _ _ _ _ _ _ Hl _ pi2)...
    intros ; refine (IH _ pi0 _ _)...
...
- list_simpl ; rewrite app_assoc ; eapply ex_oc_ir...
  ...
  simpl in Hs ; refine (IHn _ _ _ _ _ _ Hl _ pi2)...
  intros ; refine (IH _ pi0 _ _ )...
...
- list_simpl ; rewrite app_assoc ; apply lpam_ilr...
  ...
  simpl in Hs ; refine (IHn _ _ _ _ _ _ Hr _ pi2)...
  intros ; refine (IH _ pi0 _ _ )...
...
- (* de_ilr *)
  ...
  + eapply (cut_oc_comm_left _ (ipsize pi1))...
    * intros lw pi0 Hs pi.
      simpl in Hc ; refine (IHsize _ _ _ _ _ pi0 Hl _ _) ; simpl...
    * apply de_ilr...
  + rewrite 2 app_assoc.
    apply de_ilr.
    revert Hl IHsize ; list_simpl ; intros Hl IHsize.
