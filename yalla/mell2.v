...
From OLlibs Require Import funtheory dectype List_more PermutationT_more Dependent_ForallT.
...
| ex_r l1 l2 : mell l1 -> PermutationT l1 l2 -> mell l2
...
Instance mell_perm : Proper ((@PermutationT _) ==> arrow) mell.
...
- eapply ll_def.ex_r; [ apply IHpi | apply PermutationT_map; assumption ].
...
- eapply ll_def.ex_r.
  ...
  + cbn. rewrite map_app. apply PermutationT_cons, PermutationT_app_comm. reflexivity.
...
- decomp_map Heql0 eqn:Heq. subst.
  ...
  apply PermutationT_app_head, PermutationT_app_tail, PermutationT_map, HP.
